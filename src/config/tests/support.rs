...
const CONFIG_ENV_KEYS: [&str; 25] = [
    ...
    "GIT_AI_COMMIT_REDACTION_URL",
    "GIT_AI_COMMIT_REDACTION_EMAIL",
    "GIT_AI_COMMIT_REDACTION_IP",
    "GIT_AI_COMMIT_REDACTION_CIDR",
    "GIT_AI_COMMIT_REDACTION_PHONE",
    "GIT_AI_COMMIT_REDACTION_PERSON",
    "GIT_AI_COMMIT_REDACTION_ORGANIZATION",
